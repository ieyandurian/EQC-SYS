 ...
 %>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-head-line">Manage Lecturer</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<table>
								<tr>
									...
									<th class="center" width="170px">Actions</th>
								</tr>
						...
						SELECT * from lecturer order by lecturerID asc
						</sql:query>
								<c:forEach items="${result.rows}" var="row">
									<tr>
										<td><c:out value="${row.lecturerID}" /></td>
										<td><c:out value="${row.lecturerFirstName}" /></td>
										<td><c:out value="${row.lecturerLastName}" /></td>
										<td><c:out value="${row.lecturerPhoneNumber}" /></td>
										<td><c:out value="${row.lecturerEmail}" /></td>
										<td><c:out value="${row.lecturerFaculty}" /></td>
										<td class="center"><a
											href="../userAdmin/updatelecturer.jsp?lecturerID=<c:out value="${row.lecturerID}" />"
											class="btn btn-primary"><i class="fa fa-edit"></i> Edit </a>
											<a
											href="../deletelecturer?lecturerID=<c:out value="${row.lecturerID}" />"
