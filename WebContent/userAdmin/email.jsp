					...
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a href="../userAdmin/managelecturer.jsp">Manage
									Lecturer</a></li>
							<li><a class="menu-top-active" href="../userAdmin/email.jsp">Email</a></li>
						...
						<div class="panel-body">
							<form action="../EmailServlet" method="post">
								<div class="form-group">
									<label for="exampleAddress">Recipient address </label> <input
										type="text" name="recipient" size="50" />
								</div>
								<div class="form-group">
									<label for="exampleSubject">Subject</label> <input type="text"
										name="subject" size="50" />
								</div>
								<div class="form-group">
