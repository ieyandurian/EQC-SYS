				...
				<div class="col-md-max">
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="center">
								<h3>Please download the generated exam paper and answer
									schemes by clicking on the buttons below.</h3>
							</div>
							<hr />
							<div class="center">
								<a href="../DownloadServlet?id=1"><button type="button"
										class="btn btn-success" style="width:200px;">Download Exam Paper</button></a> <a
									href="../DownloadServlet?id=2"><button type="button"
										class="btn btn-success" style="width:200px;">Download Answer Schemes</button> </a>
							</div>
							<hr />
						</div>
					</div>
