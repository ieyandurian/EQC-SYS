					...
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a class="menu-top-active"
								href="../userLecturer/myaccount.jsp">My Account</a></li>
			...
			<div class="row">
				<div class="" style="width: 100%; padding: 0 20% 0;">
					<div class="panel panel-default">
						...
						<sql:param value="<%=currentUser.getLecturerID()%>" />
						</sql:query>
						<c:forEach items="${result.rows}" var="row">
							<div class="panel-body">
								<form name="UpdateAccountServlet" action="../updateaccount">
									<div class="form-group">
										<label for="exampleInputID">ID</label> <input type="text"
											class="form-control" id="id" name="lecturerID"
											value="${row.lecturerID}" readonly required />
									</div>
									<div class="form-group">
