				...
				<div class="" style="width: 100%; padding: 0 20% 0;">
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="center">
								<h2>Create Question Automatically</h2>
							</div>
						</div>
						<div class="panel-body">
							<form name="CreateQuestionAutoServlet"
								action="../createquestionauto">
								<h4>Please choose one for each of the categories below:</h4>
								<hr>
								<div class="form-group">
									<label>Topic Code</label> <select class="form-control"
										name="questionTopicCode" required>
										<option value="">---</option>
								...
								<div class="form-group">
									<label>Difficulty</label> <select class="form-control"
										name="questionDifficulty" required>
										<option value="">---</option>
