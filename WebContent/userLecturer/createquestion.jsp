				...
				<div class="col-md-12">
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a class="menu-top-active" href="../userLecturer/createquestion.jsp">Create
									Question</a></li>
			...
			<div class="row">
				<div class="" style="width: 100%; padding: 0 20% 0;">
					<div class="panel panel-default">
						...
						<div class="center">
							<a href="../userLecturer/createquestionmanual.jsp" class="btn btn-success"
								style="border-radius: 25%; height: 150px; width: 250px;"> <i
								class="fa fa-file dashboard-div-icon"></i>
								<h5 style="text-decoration: none;">Create Question Manually</h5>
							</a> <a href="../userLecturer/createquestionauto.jsp" class="btn btn-success"
								style="border-radius: 25%; height: 150px; width: 250px;"> <i
								class="fa fa-file dashboard-div-icon"></i>
								<h5>Create Question Automatically</h5>
							</a>
						</div>
					</div>
				</div>
