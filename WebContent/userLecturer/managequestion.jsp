				...
				<div class="col-md-12">
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a class="menu-top-active" href="../userLecturer/managequestion.jsp">Manage
									Question</a></li>
			...
			<div class="row">
				<div class="col-md-max">
					<div class="panel panel-default">
						<div class="panel-body">
							<table>
								<tr>
									...
									<th class="center" width="5%">Difficulty</th>
									<th class="center" width="6%">Marks<br>Allocated</th>
									<th class="center" width="5%">Topic<br>Code</th>
									<th class="center" width="29%">Questions</th>
									<th class="center" width="33%">Answer</th>
									<th class="center" width="5%">Lecturer<br>ID</th>
									<th class="center" width="5%">Shared<br>Access</th>
									<th class="center" width="8%">Actions</th>
								</tr>
						...
						SELECT q.* , l.*, o.* from questionbank q inner join ownership o on q.questionID = o.questionID inner join lecturer l on o.lecturerID = l.lecturerID where l.lecturerID = <%=currentUser.getLecturerID() %> or o.shareAccess = 'Yes' order by q.questionTopicCode,q.questionQuestion, q.questionID
						</sql:query>
							<c:forEach items="${result.rows}" var="row">
								<tr>
									...
									<td><c:out value="${row.lecturerID}" /></td>
									<td><c:out value="${row.shareAccess}" /></td>
									<td><a href="../userLecturer/editquestion.jsp?questionID=<c:out value="${row.questionID}" />" class="btn btn-primary"><i class="fa fa-edit" title="Edit"></i>
									</a> <a href="../deletequestion?questionID=<c:out value="${row.questionID}" />" class="btn btn-danger" title="Delete"> <i
											class="fa fa-trash"></i>
									</a></td>
								</tr>
							</c:forEach>
